...
import { BACKEND_URL, CLIENT_NAME, CONNECTION_PARAMETER_TOKEN, CONNECTION_TOKEN, SELECTABLE_CAR_MESHES } from '../constants';
    ...
    onDocumentMouseUp(e) {
        ...
        if(delay <= 300) {
            ...
            if(intersects.length > 0) {       
                ...
                while(scm.includes(this.selectedMesh.name) === false && meshCounter < 5) {
                    meshCounter++;
                    this.selectedMesh = intersects[meshCounter].object;
                };
