...
import { PathTracingRenderer,
  PhysicalPathTracingMaterial, PhysicalCamera, PathTracingSceneGenerator } from 'three-gpu-pathtracer';
...
async function init() {
	...
	const gltfPromise = new GLTFLoader()
		.loadAsync( 'GlassHurricaneCandleHolder.glb' )
		.then( gltf => {
